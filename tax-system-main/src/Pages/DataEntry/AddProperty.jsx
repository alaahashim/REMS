...
const AddProperty = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({
        text: `تم تسجيل العقار وربط بياناته بنجاح! رقم العقار: ${result.id}`,
        type: 'success'
      });
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Row>
                  <Col md={4}>
                    <Form.Group className="mb-3">
                      ...
                      <Form.Select
                        name="governorateId"
                        value={propertyData.governorateId}
                  ...
                  <Col md={4}>
                    <Form.Group className="mb-3">
                      <Form.Label className="text-primary fw-bold">
                        المركز <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Select
                        name="centerId"
                        value={propertyData.centerId}
                        onChange={handlePropertyChange}
                        required
                        disabled={!propertyData.governorateId}
                      >
                  ...
                  <Col md={4}>
                    <Form.Group className="mb-3">
                      <Form.Label className="text-primary fw-bold">
                        اسم الشارع <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Select
                        name="streetId"
                        value={propertyData.streetId}
                        onChange={handlePropertyChange}
                        required
                        disabled={!propertyData.centerId}
                      >
                  ...
                  <Col md={4}>
                    <Form.Group className="mb-3">
                      <Form.Label className="text-primary fw-bold">
                        الحي / المنطقة الضريبية <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Select
                        name="neighborhoodId"
                        value={propertyData.neighborhoodId}
                        onChange={handlePropertyChange}
                        required
                        disabled={!propertyData.centerId}
                      >
                ...
                <Row>
                  <Col md={12}>
                    <Alert variant="info" className="py-2">
                      ...
                      <div>
                        بيانات المالك لا تُسجّل في هذه المرحلة. سيتم ربط المالك لاحقاً من صفحة
                        "ربط المالك" مع الاسم، الرقم القومي، الهاتف، والإيميل.
                      </div>
                    </Alert>
                  </Col>
                </Row>
                  ...
                  <Form.Check
                    ...
                    label={
                      <span className="text-primary fw-bold">
                        ملكية فردية للعقار بالكامل (فيلا / منزل)
                      </span>
                    }
                    name="isSingleOwner"
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                <Form.Select
                                  ...
                                  value={unit.unitType}
                                  onChange={(e) =>
                                    handleUnitChange(index, 'unitType', e.target.value)
                                  }
                                >
                              ...
                              <td>
                                <Form.Control
                                  ...
                                  value={unit.floor}
                                  onChange={(e) =>
                                    handleUnitChange(index, 'floor', e.target.value)
                                  }
                                />
                              </td>
                              ...
                              <td>
                                <Form.Select
                                  ...
                                  value={unit.usage}
                                  onChange={(e) =>
                                    handleUnitChange(index, 'usage', e.target.value)
                                  }
                                >
                  ...
                  <div className="border border-success p-3 rounded bg-light">
                    ...
                    <Row>
                      <Col md={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            كود / رقم الوحدة <span className="text-danger">*</span>
                          </Form.Label>
                          <Form.Control
                            type="text"
                            value={units[0]?.unitNumber || ''}
                            onChange={(e) => handleUnitChange(0, 'unitNumber', e.target.value)}
                            placeholder="مثال: 1"
                            required
                          />
                        </Form.Group>
                      ...
                      <Col md={4}>
                        <Form.Group className="mb-3">
                          <Form.Label>
                            المساحة الكلية للعقار (م²) <span className="text-danger">*</span>
                          </Form.Label>
                          <Form.Control
                            type="number"
                            value={totalArea}
                ...
                <div className="d-flex justify-content-between mt-5">
                  ...
                  >
                    {loading ? (
                      <>
                        <Spinner size="sm" animation="border" /> جاري الحفظ...
                      </>
                    ) : (
                      'حفظ'
                    )}
