...
const Collection = () => {
  ...
  const isFullyPaid = pendingInstallments.length === 0 && unit && unit.status !== 'New'; 
            ...
            <Card.Body>
              ...
              {!loading && !unit && !errorMsg && (
                <div className="text-center py-5 text-muted">
                  ...
                  <h5>استخدم خانة البحث أعلاه لإدخال رقم الوحدة</h5>
                  <p>سيتم عرض بيانات الوحدة والأقساط المستحقة هنا.</p>
                </div>
              )}
