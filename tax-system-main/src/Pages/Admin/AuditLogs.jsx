...
// import { Card, Container, Table, Spinner, Badge, Button, Form } from 'react-bootstrap';
...
//                         </td>
//                         <td>{log.entity}</td>
//                         <td style={{fontSize:'0.85rem', maxWidth:'200px'}} className="text-muted">{log.details}</td>
//                     </tr>
//                 ))}
//             </tbody>
//             </Table>
...
import React, { useState, useEffect } from 'react';
import { Card, Container, Table, Spinner, Badge, Button } from 'react-bootstrap';
import { getSystemLogs } from '../../services/adminService';
